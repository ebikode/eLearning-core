...
func GetGradeReportsEndpoint(grs grd.GradeService) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		reports := grs.GetGradeReports(page, limit)
...
func GetUserGradesEndpoint(grs grd.GradeService, userType string) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		var grades []*md.Grade
		grades = grs.GetUserGrades(userID)
...
// GetCourseGradesEndpoint all grades of a tutor user
func GetCourseGradesEndpoint(grs grd.GradeService, userType string) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		grades := grs.GetCourseGrades(userID, int(courseID), page, limit)
